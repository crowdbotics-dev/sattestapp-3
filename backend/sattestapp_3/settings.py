"""
Django settings for sattestapp_3 project.
...
ROOT_URLCONF = 'sattestapp_3.urls'
...
WSGI_APPLICATION = 'sattestapp_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sattestapp_3 API",
    "DESCRIPTION": "API documentation for sattestapp_3 App",
    "VERSION": "v1",
}
